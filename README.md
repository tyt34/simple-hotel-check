...
## Описание
 - Данное приложение позволяет найти отели. Для этого небходимо выбрать город, дату заселения, продолжительность съема отеля.
...
## Функциональность
 - На странице поиска данные по умполчанию: 
 - - Город Москва.
 - - Текущая дата.
 - - Длительность проживания - 1 день.
 - При загрузки страницы сразу находятся отели соответствующие данным по умолчанию.
